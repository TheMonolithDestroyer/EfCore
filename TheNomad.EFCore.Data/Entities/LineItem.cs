...
namespace TheNomad.EFCore.Data.Entities
{
    public class LineItem : IValidatableObject //#A
    {
        ...
        [Range(1, 5, ErrorMessage = "This order is over the limit of 5 books.")] //#B
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate (ValidationContext validationContext) //#C
        {
